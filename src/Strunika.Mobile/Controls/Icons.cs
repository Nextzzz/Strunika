...
public static class Icons
{
    ...
    private static readonly Dictionary<string, Glyph> All = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["dots"] = new(Array.Empty<string>(), new[] { (6f, 12f, 1.7f), (12f, 12f, 1.7f), (18f, 12f, 1.7f) }),
        ["minus"] = new(new[] { "M5 12h14" }, Array.Empty<(float, float, float)>()),
        ["vol"] = new(new[] { "M4 9.5h3.5L12 5.5v13L7.5 14.5H4z", "M15.5 9.5a4 4 0 0 1 0 5", "M18 7a7.5 7.5 0 0 1 0 10" }, Array.Empty<(float, float, float)>()),
        ["prevCh"] = new(new[] { "M6 5.5v13" }, Array.Empty<(float, float, float)>(), new[] { "M18 5.5v13L8.5 12z" }),
        ["nextCh"] = new(new[] { "M18 5.5v13" }, Array.Empty<(float, float, float)>(), new[] { "M6 5.5v13L15.5 12z" }),
