...
**The track is the editing surface, as in a DAW.** A chord is drawn as a **block over the time it lasts**, not a badge at the moment it starts: tap one to work on it, **drag its middle to move it, drag either end to pull that end**, both snapping to beats within 16 pt. The song stops for a drag and stays stopped. **The playhead never changes what is being worked on** — that is the reader's choice and it keeps it while the song plays. Tapping beside the chords lets go of the choice.
